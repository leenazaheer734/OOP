...
namespace BankWithGUI.DL
{
    class ClientDL
    {
        ...
        public static void StoreClientInFile(Client info)
        {
            ...
            myFile.WriteLine(info.ClientCred.Username + "," + info.ClientCred.Password + "," + "client" + "," + info.ClientCred.Phonenumber + "," + info.ClientCred.Address + "," + info.Account.AccountNumber + "," + info.Account.Balance + "," + info.Account.Type + "," + info.Account.Status);
            myFile.Flush();
            myFile.Close();
        }
        ...
        public static void UpdateClientDataInFile()
        {
            ...
            foreach (Client c in clients)
            {
                myFile.WriteLine(c.ClientCred.Username + "," + c.ClientCred.Password + "," + "client" + "," + c.ClientCred.Phonenumber + "," + c.ClientCred.Address + "," + c.Account.AccountNumber + "," + c.Account.Balance + "," + c.Account.Type + "," + c.Account.Status);
            }
            myFile.Flush();
            myFile.Close();
        }
